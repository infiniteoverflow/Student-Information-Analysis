...
class StudentDetails:
    def __init__(self):
       ...
       # photo = ImageTk.PhotoImage(image)
        ...
        self.b1 = Button(self.c,text='Click here!',bg='blue',fg='white',activebackground='black',activeforeground='white',width=15,height=2, font=("Times",15,'bold'),command=self.onClick1)
